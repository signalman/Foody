    ...
    public void createNutrient(String email) {
        ...
        if(gender==1) { // 남자
            if(age<=8){
                ...
                sodium = 1200;
                iron = 9;
                fats = Math.round((10.1 * 5)*100)/100.0;
                ...
                sodium = 1500;
                iron = 11;
                fats = Math.round((10.8 * 4.9)*100)/100.0;
                ...
                sodium = 1500;
                iron = 14;
                fats = Math.round((13.5 * 4.3)*100)/100.0;
                ...
                sodium = 1500;
                iron = 14;
                fats = Math.round((15.7 * 4.5)*100)/100.0;
                ...
                sodium = 1500;
                iron = 10;
                fats = Math.round((14.6 * 4.5)*100)/100.0;
                ...
                sodium = 1500;
                iron = 10;
                fats = Math.round((12.9 * 4.3)*100)/100.0;
                ...
                sodium = 1500;
                iron = 10;
                fats = Math.round((10.4 * 5)*100)/100.0;
                ...
                sodium = 1300;
                iron = 9;
                fats = Math.round((8.2 * 6)*100)/100.0;
            }else{
                energy = 1900;
                protein = 60;
                dietaryFiber = 25;
                ...
                sodium = 1100;
                iron = 9;
                fats = Math.round((5.9 * 7.7)*100)/100.0;
            }
        }
        else { // 여자
            if(age<=8){
                ...
                sodium = 1200;
                iron = 9;
                fats = Math.round((7.8 * 5.5)*100)/100.0;
            }else if(age>=9 && age<=11){
                energy = 1800;
                protein = 45;
                dietaryFiber = 25;
                ...
                sodium = 1500;
                iron = 10;
                fats = Math.round((10.1 * 4.5)*100)/100.0;
            }else if(age>=12 && age<=14){
                energy = 2000;
                protein = 55;
                dietaryFiber = 25;
                ...
                sodium = 1500;
                iron = 16;
                fats = Math.round((10.2 * 5)*100)/100.0;
            }else if(age>=15 && age<=18){
                energy = 2000;
                protein = 55;
                dietaryFiber = 25;
                ...
                sodium = 1500;
                iron = 14;
                fats = Math.round((11.1 * 5)*100)/100.0;
            }else if(age>=19 && age<=29){
                energy = 2000;
                protein = 55;
                dietaryFiber = 20;
                ...
                sodium = 1500;
                iron = 14;
                fats = Math.round((11.2 * 5.2)*100)/100.0;
            }else if(age>=30 && age<=49){
                energy = 1900;
                protein = 50;
                dietaryFiber = 20;
                ...
                sodium = 1200;
                iron = 14;
                fats = Math.round((9.7 * 4.6)*100)/100.0;
            }else if(age>=50 && age<=64){
                energy = 1700;
                protein = 50;
                dietaryFiber = 20;
                ...
                sodium = 1500;
                iron = 8;
                fats = Math.round((8.2 * 5.25)*100)/100.0;
            }else if(age>=65 && age<=74){
                energy = 1600;
                protein = 50;
                dietaryFiber = 20;
                ...
                sodium = 1300;
                iron = 8;
                fats = Math.round((5.5 * 7)*100)/100.0;
            }else{
                energy = 1500;
                protein = 50;
                dietaryFiber = 20;
                ...
                sodium = 1100;
                iron = 7;
                fats = Math.round((3.4 * 10)*100)/100.0;
            }
        }
