...
==== HTTP Request
include::{snippets}/member/nickname/http-request.adoc[]

==== HTTP Response
include::{snippets}/member/nickname/http-response.adoc[]
include::{snippets}/member/nickname/response-body.adoc[]
